...
<style>
    ...
    #cardDetails {
        ...
        background-image: url("../bank_images/creditCard.gif");
        /* b-position:center; */
    ...
    <section>
        ...
        <div id="cardDetails">
            <fieldset>
                ...
                <div id="FieldInside">
                    <form action="Pay_CreditCard.php" method="POST">
                        ...
                        <div class="inputDetails">
                            ...
                            <input type="number" placeholder="Date" id="DateCardNumber" name="creditCardDate">
                        </div>
                        <div class="inputDetails">
...
if (isset($_POST['payBtn'])) {
    ...
    if ($creditCardHolderName == null && $creditCardHolderName == '' && $creditCardNumber == null && $creditCardNumber == '' && $creditCardDate == null && $creditCardDate == '' && $CVVnumber == null && $CVVnumber == '' && $amount == null && $amount == '') {
                        ...
                        if (amountPay != '' && amountPay > 0 && amountPay != 0) {
                            ...
                            if (accBal > parseInt(amountPay)) {
                                ...
                                if (parseInt(OTPvalidation) == OTP) {
                                    ...
                                    const trancation = "payment_by/Credit Card/No Id avaliable/Date/" + trancationDate + "/time/" + trancationTime + "/tranType/Debit/amount/" + amountPay + "/AccountBalance/" + afterDedaction;
